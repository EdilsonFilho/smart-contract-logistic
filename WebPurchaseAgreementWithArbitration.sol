...
contract WebPurchaseAgreementWithArbitration {
    ...
    uint public valorDasMercadorias;
        ...
        ) public
    {
        ...
        valorDasMercadorias = _valorDasMercadorias;
    ...
    function registrarFrete(uint _quantidadeDeContainers) inState(State.Aberto) public payable {
        ...
        listaDeFretes.push(frete(msg.sender, _quantidadeDeContainers, valorDasMercadorias ,valorDoFrete*_quantidadeDeContainers, true));
    }
    ...
    function embarcarCompra() inState(State.Aberto) public {
        require(msg.sender == afretador, "Somente o afretador pode fazer isso.");
        dataDePartida = now;
        state = State.EmViagem;
    }
        
    function desembarcarCompra() inState(State.EmViagem) public {
        require(msg.sender == afretador, "Somente o afretador pode fazer isso.");
        dataDeChegada = now;
